export function Disclaimer() {
  return (
    <aside className="rounded-lg border border-orange-200/70 bg-orange-50/45 px-4 py-3 text-xs leading-relaxed text-zinc-700">
      <p className="font-medium text-orange-900">Research-only estimates</p>
